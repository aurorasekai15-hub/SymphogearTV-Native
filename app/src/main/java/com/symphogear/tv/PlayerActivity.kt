            ...
            if (isClearKey) {
                ...
                try {
                    ...
                    mediaItem = MediaItem.Builder()
                        ...
                        .build()
                    Log.d("DRM_DEBUG", "ClearKey mediaItem built OK")
                } catch (e: Exception) {
                ...
                mediaItem = MediaItem.Builder()
                    ...
                    .build()
                Log.d("DRM_DEBUG", "Widevine mediaItem built, licUri=$drmLicense")
            }
        } else if (!current?.drmName.isNullOrBlank() && drmLicense == null) {
            // DRM channel tapi license tidak ditemukan di cache - ini bug!
